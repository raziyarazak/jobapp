      ...
      <div class="col-lg-8 col-xl-6">
        <div class="card rounded-3">
          ...
          <div class="card-body p-4 p-md-5">
            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2"align ="center">Registration Info</h3>
            <p>${feebackMessage}</p>
				<br/>
              ...
              <div class="mb-4">
                ...
                <label for="inputJobCat" class="form-label">User type</label>
						    <select id="usertype" name="usertype" class="form-select" onchange="enableUser(this)"required>
                  ...
                  <div class="row">
                    <div class="form-outline mb-4">
						    <label for="inputJobCat" class="form-select d-none">Job Category</label>
						    <select id="jobcategory" name="jobcategory"  class="d-none"   required>
						      <option value="" selected="selected" disabled="disabled" >-- select one --</option>
              ...
              <button type="submit" class="btn btn-info">Submit</button>
                ...
                <a class="btn btn-light" href="signin.jsp" role="button">Sign In</a>
              </div>
 ...
 <script type="text/javascript">
  function enableUser(answer){
	console.log(answer.value);  
	  if(answer.value == "consultant"){
		document.getElementById('jobcategory').classList.remove('d-none');  
	
	  }else{
		  document.getElementById('jobcategory').classList.add('d-none'); 
	  }
  };
